<?php require __DIR__ . "/utilities/Utilities.php";?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <script src="<?php echo Utilities::domain();?>//js/paging.js?v=<?php echo md5(uniqid(rand(), true));?>"></script>
        <script src="<?php echo Utilities::domain();?>//js/defined/statistics.js?v=<?php echo md5(uniqid(rand(), true));?>"></script>
        <script src="<?php echo Utilities::domain();?>//js/defined/todo-list.js?v=<?php echo md5(uniqid(rand(), true));?>"></script>
        <script src="<?php echo Utilities::domain();?>//js/defined/employee-list.js?v=<?php echo md5(uniqid(rand(), true));?>"></script>
        <script src="<?php echo Utilities::domain();?>//js/defined/message.js?v=<?php echo md5(uniqid(rand(), true));?>"></script>
        <script src="<?php echo Utilities::domain();?>//js/defined/service-prod.js?v=<?php echo md5(uniqid(rand(), true));?>"></script>
